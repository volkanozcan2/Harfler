...
const App: React.FC = () => {
  ...
  const handleLetterSelect = useCallback((item: AlphabetItem) => {
    ...
    // Format: /images/A_Araba.png
    const imagePath = `/images/${item.letter}_${randomExample.word}.png`;
  ...
  const handleRegenerate = useCallback(() => {
    ...
    const imagePath = `/images/${item.letter}_${nextExample.word}.png`;
  ...
  // No coloring book feature anymore
